    ...
    >
      ...
      >
        <div className="eyebrow" style={{ marginBottom: 18 }}>
          For Spoonflower sellers, by Spoonflower sellers · not affiliated
          with Spoonflower Inc.
        </div>
        <h1
          style={{
        ...
        >
          Find better SEO keywords for your Spoonflower listings, organize
          them by theme, and rewrite tags without leaving your workshop. The
          paid companion to the free Chrome extension.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          $10 / month · cancel anytime · the free extension stays free
        </div>
      </div>
    </section>
  );
...
function Featurelets() {
  const items = [
    {
      hed: "40 keyword ideas",
      sub: "per listing, ranked by score, in under 30 seconds.",
    },
    {
      hed: "Organized by bucket",
      sub: "themed groups that track your shop's real categories.",
    },
    {
      hed: "Right inside Spoonflower",
      sub: "or in a focused web workspace — your call.",
    },
  ];
  return (
    <section
